---
title: AI Agent
description: "Streaming chat, multiple providers, tool use, extended thinking, voice dictation, Jarvis Mode read-aloud, and live editor streaming."
---
...
- **Tool use** AI can read files, write files, create files, list directories, search code, and create git worktrees directly in your project — see [Workspaces & Worktrees](/workspaces)
...
- **Jarvis Mode (read-aloud)** the agent can read its own replies back to you, or speak a short summary on its own when Jarvis Mode is on; see [Jarvis Mode](/jarvis-mode)
