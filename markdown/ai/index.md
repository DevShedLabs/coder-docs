...
- **Math formulas in chat** write `$...$`/`$$...$$` LaTeX and it renders as typeset math via KaTeX (see [Math Formulas](../math/index.md))
...
- **Skills** progressive-disclosure instructions the agent loads on demand, see [Skills](../skills/index.md)
