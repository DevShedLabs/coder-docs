...
description: "Per-round token logging, daily/session/7-day breakdowns, and a rebuild-from-history tool."
---
...
See also [Reports](/reports) for a full verbatim recorder of every request/response, not just token counts.
