...
description: "A real editor tab that's a sandboxed embedded browser, split it alongside your code."
---
...
See also [Live Reload](/livereload), which can also open its preview in-app.
