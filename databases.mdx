---
title: Databases
description: "SQLite, MySQL, PostgreSQL, MongoDB, and Redis behind one connection tree and query console."
---

![Databases](media/databases.jpg)
...
### MongoDB 
![MongoDB](media/mongo.jpg)

### SQLite
![SQLite](media/sqlite.jpg)