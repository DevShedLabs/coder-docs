---
title: Mindmaps
description: "Plain-text .mindmap.md files with an interactive canvas view."
---

![Mindmap](media/mindmaps.jpg)
...
- **Math in labels** a label containing `$...$`/`$$...$$` renders as typeset LaTeX math via KaTeX (see [Math Formulas](/math)) instead of literal text; node sizing accounts for the rendered formula so math-heavy nodes don't clip
